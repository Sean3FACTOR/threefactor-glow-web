const LiveBadge = () => (
  <span className="inline-flex items-center ml-2 px-2 py-0.5 text-xs font-medium" style={{ backgroundColor: "rgba(243,111,33,0.15)", color: "#F36F21" }}>
    <span className="relative flex h-2 w-2 mr-1">
      <span className="animate-ping absolute inline-flex h-full w-full opacity-75" style={{ backgroundColor: "#F36F21" }} />
      <span className="relative inline-flex h-2 w-2" style={{ backgroundColor: "#F36F21" }} />
    </span>
    LIVE
  </span>
);
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-0 relative">
          ...
          {steps.map((step, index) => (
            <div key={step.title} className="relative px-4 pb-8 md:pb-0">
              {/* Step number */}
