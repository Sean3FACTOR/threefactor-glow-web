...
const Certifications = () => {
  return <section className="py-12 border-y border-border bg-background">
      <div className="container mx-auto px-4">
        <p className="text-center text-sm mb-8 uppercase tracking-widest text-primary-foreground">
        ...
        <div className="mt-12 pt-8 border-t border-border">
          <p className="text-center text-sm uppercase tracking-widest mb-6 text-primary-foreground">
            Trusted by Fortune 500 companies
          </p>
          <div className="flex items-center justify-center gap-8 md:gap-12">
            <div className="text-center">
              <span className="block text-3xl md:text-4xl font-bold text-foreground">15+</span>
              <span className="text-xs md:text-sm text-primary-foreground">Years Experience</span>
            </div>
            <div className="w-px h-12 bg-border" />
            <div className="text-center">
              <span className="block text-3xl md:text-4xl font-bold text-foreground">100+</span>
              <span className="text-xs md:text-sm text-primary-foreground">Clients Served</span>
            </div>
            <div className="w-px h-12 bg-border" />
            <div className="text-center">
              <span className="block text-3xl md:text-4xl font-bold text-foreground">Global</span>
              <span className="text-xs md:text-sm text-primary-foreground">Coverage</span>
            </div>
          </div>
        </div>
      </div>
