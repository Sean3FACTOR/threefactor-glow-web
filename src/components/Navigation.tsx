  ...
  return <nav className="fixed top-0 left-0 right-0 z-50 shadow-sm" style={{
    ...
    borderBottom: "1px solid rgba(59,59,57,0.08)"
      ...
      <div className="container mx-auto py-0">
        <div className="flex items-center justify-between h-[3rem] md:h-[3.5rem]">
          <Link to="/" className="flex items-center h-full py-1">
            <img alt="3FACTOR" className="h-[132%] w-auto object-contain" src="/lovable-uploads/b9dae896-d800-446d-8f26-98d2f7dbb6c3.png" />
          </Link>
