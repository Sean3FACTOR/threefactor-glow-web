...
const successOutcomes = ["Instead of guessing which framework matters, your team knows exactly what to build, and why.", "Instead of stalled RFPs, security reviews become a formality.", "Instead of scrambling before audits, your posture is already defensible."];
const roadmapBenefits = ["Which frameworks unlock your next market", "Which ones you can safely ignore", "How to turn compliance into a sales accelerator, not a bottleneck"];
  ...
  return <div className="min-h-screen" style={{
    backgroundColor: "#3B3B39"
            ...
            <div className="text-left">
              <div className="space-y-4">
                <p className="text-2xl md:text-3xl font-bold text-white leading-snug whitespace-nowrap">
                  Stop treating compliance like a chore. Start treating it like a competitive advantage.
                </p>
                ...
                <p className="text-lg md:text-xl font-semibold text-white text-left inline-block pl-6 mt-2" style={{
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="space-y-8">
              <div className="p-8 text-left" style={{
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="pl-6 text-left" style={{
      ...
      borderTop: "1px solid rgba(255,255,255,0.08)"
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <Button asChild size="lg" className="text-white font-semibold mb-8" style={{
            backgroundColor: "#F36F21"
          }}>
              <Link to="/contact">Get Your Framework Roadmap <ArrowRight className="w-4 h-4 ml-2" /></Link>
            </Button>
