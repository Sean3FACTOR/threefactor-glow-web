          ...
          <div className="grid grid-cols-12 gap-8 items-center">
            <div className="col-span-12 lg:col-span-7">
              ...
              <h1
                ...
                style={{ color: "#3B3B39" }}
              >
                ISO 27001, delivered through an integrated compliance program — built to scale across standards and regulations.
              </h1>
              ...
              <div className="flex items-center gap-2 mb-6">
                <span
                  className="inline-block px-3 py-1 text-xs font-mono border"
