      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <h1 className="text-4xl md:text-5xl font-bold mb-8" style={{ color: "#3B3B39" }}>
              Privacy Policy
            </h1>
            
            <div className="prose max-w-none space-y-8" style={{ color: "#3B3B39" }}>
              <p className="text-lg leading-relaxed">
                At 3<span style={{ color: "#F36F21" }}>FACTOR</span>, we value your privacy and are committed to protecting your personal information. This privacy policy outlines how we collect, use, and safeguard your information when you visit our website.
              </p>

              <section>
                <h2 className="text-2xl font-semibold mb-4" style={{ color: "#3B3B39" }}>Information we collect</h2>
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4" style={{ color: "#3B3B39" }}>How we use your information</h2>
                <p className="leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4" style={{ color: "#3B3B39" }}>Sharing your information</h2>
                <p className="leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4" style={{ color: "#3B3B39" }}>Security</h2>
                <p className="leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4" style={{ color: "#3B3B39" }}>Links to other websites</h2>
                <p className="leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4" style={{ color: "#3B3B39" }}>Changes to our privacy policy</h2>
                <p className="leading-relaxed">
              ...
              <section className="pt-4" style={{ borderTop: "1px solid rgba(59,59,57,0.1)" }}>
                <p className="leading-relaxed">
