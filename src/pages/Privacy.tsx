        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="prose prose-invert max-w-none space-y-8 text-muted-foreground">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-foreground mb-4">Changes to our privacy policy</h2>
                <p className="leading-relaxed">
              ...
              <section className="pt-4 border-t border-glass-border">
                <p className="leading-relaxed">
                  ...
                  <a href="mailto:privacy@3factor.com" className="text-primary hover:underline">
                    privacy@3factor.com
                  </a>.
                </p>
              </section>
